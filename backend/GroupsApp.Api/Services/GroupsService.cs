...
// Alias the DTO namespace to disambiguate SplitType
using DtoSplitType = GroupsApp.Api.DTOs.SplitType;
...
namespace GroupsApp.Api.Services
{
    public class GroupsService : IGroupsService
    {
        ...
        public async Task AddMemberAsync(int groupId, CreateMemberDto dto)
        {
            ...
            _db.Users.Add(user);
            await _db.SaveChangesAsync();  // user.Id now generated by EF
        ...
        {
            // validate payer
            if (!await _db.GroupMembers
                .AnyAsync(gm => gm.GroupId == groupId && gm.UserId == dto.PayerId))
            {
            ...
            if (dto.SplitType == DtoSplitType.Equal)
            {
